...
import cd.go.authorization.generic.executors.GetAuthorizationServerUrlRequestExecutor;
...
public class GetAuthorizationServerUrlRequestTest {
    ...
    public void shouldDeserializeGoPluginApiRequestToGetAuthorizationServerUrlRequest() throws Exception {
        ...
        assertThat(authConfig.getConfiguration().genericEndpoint(), is("https://example.com"));
