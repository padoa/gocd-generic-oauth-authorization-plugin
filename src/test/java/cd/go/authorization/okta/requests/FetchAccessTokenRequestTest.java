...
import cd.go.authorization.generic.executors.FetchAccessTokenRequestExecutor;
...
public class FetchAccessTokenRequestTest {
    ...
    public void shouldDeserializeGoPluginApiRequestToFetchAccessTokenRequest() throws Exception {
        ...
        assertThat(authConfig.getConfiguration().genericEndpoint(), is("https://example.co.in"));
