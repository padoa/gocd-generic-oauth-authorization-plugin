...
public class RoleConfigValidateRequestTest {
    ...
    public void shouldDeserializeGoPluginApiRequestToRoleConfigValidateRequest() throws Exception {
        ...
        final GenericRoleConfiguration genericRoleConfiguration = request.genericRoleConfiguration();

        assertThat(genericRoleConfiguration.groups(), contains("group-1", "group-2"));
        assertThat(genericRoleConfiguration.users(), contains("bob", "alice"));
    }
}
