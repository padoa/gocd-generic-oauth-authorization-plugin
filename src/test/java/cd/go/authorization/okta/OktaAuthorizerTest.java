...
import cd.go.authorization.generic.models.*;
...
public class GenericAuthorizerTest {

    private GenericAuthorizer authorizer;
    private GenericUser loggedInUser;
    ...
    public void setUp() throws Exception {
        ...
        loggedInUser = mock(GenericUser.class);
        authConfig = mock(AuthConfig.class);

        authorizer = new GenericAuthorizer(membershipChecker);
    }
    ...
    public void shouldAssignRoleIfUserIsAMemberOfAtLeastOneGroup() throws Exception {
        ...
        final GenericRoleConfiguration roleConfiguration = mock(GenericRoleConfiguration.class);
