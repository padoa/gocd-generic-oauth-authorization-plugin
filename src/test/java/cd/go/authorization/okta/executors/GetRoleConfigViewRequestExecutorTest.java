...
import cd.go.authorization.generic.annotation.MetadataHelper;
import cd.go.authorization.generic.annotation.ProfileMetadata;
...
public class GetRoleConfigViewRequestExecutorTest {
    ...
    public void allFieldsShouldBePresentInView() throws Exception {
        ...
        final List<ProfileMetadata> metadataList = MetadataHelper.getMetadata(GenericRoleConfiguration.class);
        ...
        assertThat("should contains only inputs that defined in GenericRoleConfiguration.java",inputs, hasSize(metadataList.size()));
    }
