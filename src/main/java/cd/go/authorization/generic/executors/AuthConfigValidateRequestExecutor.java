...
import cd.go.authorization.generic.requests.AuthConfigValidateRequest;
...
public class AuthConfigValidateRequestExecutor implements RequestExecutor {
    ...
    public GoPluginApiResponse execute() throws Exception {
        ...
        final ValidationResult validationResult = new MetadataValidator().validate(genericConfiguration);
