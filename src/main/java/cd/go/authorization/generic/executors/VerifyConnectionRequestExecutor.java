...
public class VerifyConnectionRequestExecutor implements RequestExecutor {
    ...
    private final GenericApiClient providerManager;

    public VerifyConnectionRequestExecutor(VerifyConnectionRequest request) {
        this(request, new GenericApiClient(request.genericConfiguration()));
    }

    public VerifyConnectionRequestExecutor(VerifyConnectionRequest request, GenericApiClient providerManager) {
