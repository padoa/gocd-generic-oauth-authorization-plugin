...
import cd.go.authorization.generic.executors.AuthConfigValidateRequestExecutor;
...
public class AuthConfigValidateRequest extends Request {
    ...
    public AuthConfigValidateRequest(GenericConfiguration genericConfiguration) {
    ...
    public static final AuthConfigValidateRequest from(GoPluginApiRequest apiRequest) {
        return new AuthConfigValidateRequest(GenericConfiguration.fromJSON(apiRequest.requestBody()));
    }
