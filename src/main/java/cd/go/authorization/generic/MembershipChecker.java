...
public class MembershipChecker {
    ...
    public boolean isAMemberOfAtLeastOneGroup(GenericUser loggedInUser, AuthConfig authConfig, List<String> groupsAllowed) throws IOException {
    ...
    private boolean checkMembershipUsingUsersAccessToken(GenericUser loggedInUser, List<String> groupsAllowed) throws IOException {
