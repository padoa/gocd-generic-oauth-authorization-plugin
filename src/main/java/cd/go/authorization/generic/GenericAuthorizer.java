...
import cd.go.authorization.generic.models.Role;
...
public class GenericAuthorizer {
    ...
    public GenericAuthorizer(MembershipChecker membershipChecker) {
        this.membershipChecker = membershipChecker;
    }

    public List<String> authorize(GenericUser loggedInUser, AuthConfig authConfig, List<Role> roles) throws IOException {
        final GenericUser user = loggedInUser;
