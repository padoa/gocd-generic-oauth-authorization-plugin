...
import cd.go.authorization.generic.exceptions.NoSuchRequestHandlerException;
import cd.go.authorization.generic.executors.*;
import cd.go.authorization.generic.requests.*;
...
import static cd.go.authorization.generic.Constants.PLUGIN_IDENTIFIER;

@Extension
public class GenericPlugin implements GoPlugin {
    public static final Logger LOG = Logger.getLoggerFor(GenericPlugin.class);
